...
const AbsenceManagementPage = lazy(() =>
    import("../views/pages/gestion-admin/absences/AbsenceManagementPage").then(
        (module) => ({ default: module.AbsenceManagementPage }),
    ),
);
...
const UnauthorizedPage = lazy(() =>
    import("../views/pages/system/UnauthorizedPage").then((module) => ({
        default: module.UnauthorizedPage || module.default,
    })),
);
...
const NoteList = lazy(() =>
    import("../views/pages/gestion-admin/notes/NoteList").then((module) => ({
        default: module.NoteList || module.default,
    })),
);
const EleveNotesDetailPage = lazy(
    () => import("../views/pages/gestion-admin/notes/EleveNotesDetailPage"),
);
const ClasseResultsPage = lazy(
    () => import("../views/pages/gestion-admin/notes/ClasseResultsPage"),
);
                        ...
                        <Route element={<BaseLayout />}>
                            ...
                            <Route
                                ...
                                <Route
                                    ...
                                    element={
                                        <Navigate to="/admin/eleves" replace />
                                    }
                                />
                                <Route
                            ...
                            >
                                ...
                                <Route
                                    path="/notes/resultats/classe/:classeId"
                                    element={<ClasseResultsPage />}
                                />
                                <Route
                                    path="/notes/:eleveId"
                                    element={<EleveNotesDetailPage />}
                                />
                                <Route
                                    path="/absences"
                                    element={<AbsenceManagementPage />}
                                />
                            </Route>
