...
export default function MonBulletin() {
  ...
  return (
    <div style={{ fontFamily: "Arial, sans-serif", padding: "30px", maxWidth: "960px", margin: "0 auto", fontSize: "12px", color: "#000", background: "#fff" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "10px" }}>
        ...
        <div style={{ textAlign: "center" }}>
          <div style={{ fontSize: "32px", color: "#3964d1", fontWeight: "bold" }}>🎓</div>
          <div style={{ fontWeight: "bold", color: "#3964d1" }}>Saytu Edu</div>
      ...
      {/* Titre */}
      <div style={{ textAlign: "center", backgroundColor: "#3964d1", color: "white", padding: "8px", marginBottom: "12px", fontSize: "16px", fontWeight: "bold", letterSpacing: "2px" }}>
        BULLETIN DE NOTES
      </div>
      ...
      <div style={{ display: "flex", gap: "12px", marginBottom: "12px", border: "1px solid #ccc", padding: "10px", borderRadius: "4px" }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4px" }}>
           ...
           <div><strong>Classe :</strong> {classe?.nom_classe ?? classe?.nom_niveau ?? "-"}</div>
      ...
      <table style={{ width: "100%", borderCollapse: "collapse", marginBottom: "12px", fontSize: "12px" }}>
        <thead>
          <tr style={{ backgroundColor: "#3964d1", color: "white" }}>
        ...
        <tbody>
          {matieres?.map((m, index) => (
            <tr key={index} style={{ backgroundColor: index % 2 === 0 ? "#f9f9f9" : "#fff" }}>
              ...
              <td style={{ ...td, textAlign: "center", fontWeight: "bold", color: m.moyenne >= 10 ? "#3964d1" : "red" }}>
        ...
        <tfoot>
          <tr style={{ backgroundColor: "#3964d1", fontWeight: "bold"  ,color: "white"}}>
